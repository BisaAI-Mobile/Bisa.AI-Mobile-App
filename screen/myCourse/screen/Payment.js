...
export default function PaymentPage() {
  ...
  return (
    <View style={{ flex: 1 }}>
            ...
            <View style={styles.container}>
              ...
              <View style={{ flexDirection: "column", gap: 5, padding: 4 }}>
                <View style={{ flexDirection: "row", gap: 3 }}>
                  ...
                  />
                  <Text style={styles.text2}>Jumlah Peserta : 3056</Text>
                </View>
                <View style={{ flexDirection: "row", gap: 3 }}>
                  <Image
                    source={require("../../../assets/images/TotalModul.png")}
                  />
                  <Text style={styles.text2}>Total Modul : 6 Modul</Text>
                </View>
              </View>
            </View>
          </View>
      ...
      <View
        style={{ height: 65, backgroundColor: "white", alignItems: "center", borderTopColor:'grey' }}
      >
        <Pressable
          style={{ paddingTop: 10 }}
